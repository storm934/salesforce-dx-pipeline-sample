...
HEROKU_TEAM_NAME="LiquidApplicationStudioDemo"
# Descriptive name for the Heroku app
HEROKU_APP_NAME="MyLightningAppDemo"
...
# Pipeline
HEROKU_PIPELINE_NAME="pipelineDemo$TICKS"
...
# Your package name
PACKAGE_NAME="MyPacakageDemo"
### Setup script
# Support a Heroku team
HEROKU_TEAM_FLAG=""
if [ ! "$HEROKU_TEAM_NAME" == "" ]; then
	echo "esta dentro del if"
